...
const CHROME = process.env.MPGA_CHROME || '/root/.cache/ms-playwright/chromium-1234/chrome-linux64/chrome'
...
await shoot('mobile-result', { width: 390, height: 844, isMobile: true, deviceScaleFactor: 2 }, async page => {
  await page.click('#demo')
  await page.waitForSelector('#result.on', { timeout: 30000 })
  await new Promise(r => setTimeout(r, 1500))
})
