...
const CASES = [
  ...
  { file: "examples/deck-deepseek.html" },
  {
    ...
    xml: [
      ...
      ["slide2.xml", /<p:grpSp>/, "иконка собрана в группу"],
  ...
  },
  {
    ...
    xml: [
      ...
      ["slide4.xml", /<a:gradFill/, "градиент из defs стал заливкой фигуры"],
      ["slide4.xml", /<p:pic>/, "неразбираемый SVG уходит картинкой"],
      ["slide4.xml", /Размытие — картинкой/, "подпись поверх картинки — текстом"],
    ],
    maxPictures: 1,
  },
];
